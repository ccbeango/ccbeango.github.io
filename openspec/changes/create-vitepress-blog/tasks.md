...
- [x] 7.3 使用 Vitest 覆盖内容转换、系列 sidebar、Markdown 容器、EXIF、主题令牌和配置契约，不固定作者可修改的具体配置值，并以 `live-images/android-motion-photo.jpg` 覆盖真实 Android Motion Photo 定位和厂商 trailer 保留
