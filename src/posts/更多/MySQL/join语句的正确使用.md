...
![文章配图](https://cdn.jsdelivr.net/gh/ccbeango/blogImages/Mysql/join语句的正确使用01.png)
...
![文章配图](https://cdn.jsdelivr.net/gh/ccbeango/blogImages/Mysql/join语句的正确使用02.png)
...
![文章配图](https://cdn.jsdelivr.net/gh/ccbeango/blogImages/Mysql/join语句的正确使用03.png)
...
![文章配图](https://cdn.jsdelivr.net/gh/ccbeango/blogImages/Mysql/join语句的正确使用04.png)

```sql
SELECT <select_list> FROM TableA A RIGHT JOIN TableB B ON A.Key = B.key
```

![文章配图](https://cdn.jsdelivr.net/gh/ccbeango/blogImages/Mysql/join语句的正确使用05.png)
...
![文章配图](https://cdn.jsdelivr.net/gh/ccbeango/blogImages/Mysql/join语句的正确使用06.png)
...
![文章配图](https://cdn.jsdelivr.net/gh/ccbeango/blogImages/Mysql/join语句的正确使用07.png)
